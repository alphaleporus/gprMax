...
@app.cell
def _(mo):
    permittivity = mo.ui.slider(start=1.0, stop=20.0, step=0.5, value=7.0,
        label="Soil Relative Permittivity (εr)")
    frequency = mo.ui.slider(start=0.5, stop=3.0, step=0.1, value=1.0,
        label="Antenna Centre Frequency (GHz)")
    src_x = mo.ui.slider(start=0.010, stop=0.220, step=0.002, value=0.060,
        label="Source X-Position (m)")
    target_depth = mo.ui.slider(start=0.030, stop=0.150, step=0.005, value=0.080,
